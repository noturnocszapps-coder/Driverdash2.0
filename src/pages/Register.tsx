...
export const Register = () => {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 py-12 overflow-y-auto">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center w-full space-y-2 mb-8">
          ...
          <h1 className="text-3xl font-bold text-emerald-600 whitespace-nowrap overflow-visible">Criar Conta</h1>
          <p className="text-zinc-500 block w-full whitespace-normal break-normal">Comece a sincronizar seus dados na nuvem</p>
        </div>
